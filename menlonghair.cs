...
namespace VT_STYLES
{
    public partial class menlonghair : Form
    {
        public menlonghair()
        {
            InitializeComponent();
        ...
        private void menlonghair_Load(object sender, EventArgs e)
        {
        ...
        {
            fulllonghair flh = new fulllonghair();
            flh.Show();
        }
    }
}
